...
export default function EducationCard({logo, name, location, date, ...rest}: ExperienceItemProps){
  ...
  return(
    <div ref={parentRef} onClick={toggleDropdown} className = "blueBorder rounded-xl m-2 p-2 text-black bg-white dark:text-white dark:bg-[#131213] flex-col cursor-pointer">
