        ...
        <div className = "card flex flex-wrap md:flex-nowrap justify-center">
            ...
            <div className = "flex flex-col flex-1 items-center min-w-64">
                ...
                <div className = "mb-3 flex flex-wrap gap-3 justify-center">
                    <a href="https://www.linkedin.com/in/junhao-zhao/" target = "_blank" className = "blueBorder rounded-2xl hover:text-[#1E90FF] mt-2 p-1 px-3 text-black bg-white dark:text-white dark:bg-[#131213]">
                    ...
                    <a href="https://github.com/jzhao234" target = "_blank" className = "blueBorder rounded-2xl hover:text-[#1E90FF] mt-2 p-1 px-3 bg-white dark:bg-[#131213]">
                        <div className = "flex items-center">
