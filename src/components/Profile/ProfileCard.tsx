...
export default function ProfileCard(){
    return(
        <div className = "flex flex-wrap md:flex-nowrap justify-center m-10 p-3 border-2 border-[#1E90FF]/20 rounded-lg text-black bg-white dark:text-white dark:bg-[#151516]">
