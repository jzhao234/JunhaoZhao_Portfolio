...
export default function ProfileCard(){
    return(
        <div className = "card flex flex-wrap md:flex-nowrap justify-center">
            <div className="flex-shrink-0">
                <Image src = "/profile.jpg" alt = "Profile Picture" className = "rounded-xl bd-grey bd-1 mr-3 mb-3 ml-1 mt-1 border-2 border-[#1E90FF]/20" width = {150} height = {150}/>
            </div>
            <div className = "flex flex-col flex-1 items-center min-w-64">
                <div className = "mt-3 mb-3">
                    <h1 className = "text-2xl font-bold"> Junhao Zhao </h1>
                </div>
                <div className=" mb-3 text-center sm:w-98">
                    <p> Full Stack Developer | Software Engineer </p>
                </div> 
                {/* Contact Me */}
                <div className = "mb-3 flex flex-wrap gap-3 justify-center">
                    <a href="https://www.linkedin.com/in/junhao-zhao/" target = "_blank" className = "hover:text-[#1E90FF] mt-2 p-1 px-3 text-black bg-white dark:text-white dark:bg-[#131213] rounded-xl border-2 border-[#1E90FF]/15">
                    ...
                    <a href="https://github.com/jzhao234" target = "_blank" className = "hover:text-[#1E90FF] mt-2 p-1 px-3 bg-white dark:bg-[#131213] rounded-xl border-2 border-[#1E90FF]/15">
                        <div className = "flex items-center">
                    ...
                    <a href="/files/resume.pdf" download="ZhaoJunhaoResume.pdf" className="hover:text-[#1E90FF] mt-2 p-1 px-3 text-black bg-white dark:text-white dark:bg-[#131213] rounded-xl border-2 border-[#1E90FF]/15">
                        <div className = "flex items-center">
