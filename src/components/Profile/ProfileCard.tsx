...
export default function ProfileCard(){
    return(
        <div className = "max-w-150 flex-shrink-0 m-10 p-3 border-2 border-[#1E90FF]/20 rounded-lg text-black bg-white dark:text-white dark:bg-[#151516]">
            <div className = "flex flex-wrap flex-1 justify-center">
                <div className="flex-shrink-0">
                    <Image src = "/profile.jpg" alt = "Profile Picture" className = "rounded-lg bd-grey bd-1 mr-3 mb-3 ml-1 mt-1 rounded-lg border-2 border-[#1E90FF]/20" width = {150} height = {150}/>
                </div>
                <div className = "flex flex-col items-center h-full">
                    <div className = "mt-3 mb-3">
                        <h1 className = "text-2xl font-bold mb-2"> Junhao Zhao </h1>
                    </div>
                    <div className="ml-3 mb-3 text-center sm:w-98">
