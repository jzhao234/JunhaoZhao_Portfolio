...
export default function Skills(){
    return(
        <div className = "w-150 [@media(min-width:1119px)]:w-90 sm:h-150 max-w-full m-10 p-3 border-2 border-[#1E90FF]/20 rounded-lg text-black bg-white dark:text-white dark:bg-[#151516] flex-col">
