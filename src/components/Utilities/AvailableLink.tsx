export type AvailableGithubLinkProp = {
    githubLink?: string;
}

export type AvailableDemoLinkProp = {
    demoLink?: string;
}

export function AvailableGithubLink({githubLink}: AvailableGithubLinkProp){
...
export function AvailableDemoLink({demoLink}: AvailableDemoLinkProp){
